...
class BuildConfig:
    ...
    # default) preserves the original unbounded-wait behavior. Read by
    # commands/stop.py, overridable per-invocation via `bakar stop --timeout`.
...
def resolve(
    *,
    ...
    return BuildConfig(
        ...
        stop_grace_seconds=user_config.stop_grace_seconds if user_config else 0,
